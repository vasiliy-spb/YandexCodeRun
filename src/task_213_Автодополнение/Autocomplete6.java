...
//        reader.close();
//
//        TreeMap<Character,Set<String>> wordMap = new TreeMap<>();
//        TreeMap<String,Set<String>> wordMap2 = new TreeMap<>();
//
//        int totalKeyPass = 0;
//
...
//                if (wordMap2.containsKey(prefix)) {
//                    stringList = new HashSet<>(wordMap2.get(prefix));
//                }
//            } else {
//                stringList = wordMap.get(firstChar);
//            }
//
//            if (stringList != null) {
...
//                    }
//                }
//                if (wordBuilder.length() >= 2 && !wordMap2.containsKey(prefix)) {
//                    Set<String> set = new HashSet<>();
//                    set.add(word);
//                    wordMap2.put(prefix,set);
//                }
